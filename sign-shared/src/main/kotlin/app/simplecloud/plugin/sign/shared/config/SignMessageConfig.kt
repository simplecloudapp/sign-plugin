...
class SignMessageConfig {
    ...
    companion object {
        ...
        const val GROUP_REQUIRED_ARGUMENT = "$PREFIX <color:#dc2626>You need to specify a group name"
        ...
        const val SIGN_REMOVE_SUCCESS =
            "$PREFIX <color:#a3e635>Sign with target group was successfully removed"
